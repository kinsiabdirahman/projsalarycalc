  ...
  return (
    ...
    >
      ...
      <form>
        ...
        <Box>
          <FormControl>
            <FormLabel border="2px solid black" w={250} h={10}>
              NHIF Deduction:
              <strong> {nhifDeduction} </strong>
            </FormLabel>
            <br />
          </FormControl>
        </Box>
